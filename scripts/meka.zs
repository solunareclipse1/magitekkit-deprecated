...
recipes.addShapedMirrored(<mekanism:energycube>.withTag({tier: 0}), [[<ore:plateSteel>, <mekanism:energytablet>, <ore:plateSteel>],[<ic2:te:74>, <mekanism:basicblock:8>, <mekanism:energytablet>], [<ore:plateSteel>, <mekanism:energytablet>, <ore:plateSteel>]]);
...
recipes.addShaped(<mekanism:machineblock2:10>, [[<ic2:crafting:4>, <mekanism:enrichedalloy>, <ic2:crafting:4>],[<mekanism:enrichedalloy>, <mekanism:basicblock:8>, <mekanism:enrichedalloy>], [<ore:circuitAdvanced>, <ic2:te:50>, <ore:circuitAdvanced>]]);
...
recipes.addShapedMirrored(<mekanism:machineblock2:7>, [[null, <mekanism:controlcircuit:3>, null],[<mekanism:gastank>.withTag({tier: 0}).onlyWithTag({tier: 0}), <mekanism:basicblock:8>, <mekanism:gastank>.withTag({tier: 0}).onlyWithTag({tier: 0})], [<mekanism:machineblock2:11>.withTag({tier: 0}).onlyWithTag({tier: 0}), <ic2:te:56>, <ic2:crafting:4>]]);
...
recipes.addShaped(<mekanism:machineblock2:4>, [[<ore:plateSteel>, <mekanism:electrolyticcore>, <ore:plateSteel>],[<mekanism:enrichedalloy>, <mekanism:basicblock:8>, <mekanism:enrichedalloy>], [<ore:plateSteel>, <mekanism:electrolyticcore>, <ore:plateSteel>]]);
recipes.addShaped(<mekanism:machineblock2:2>, [[<ore:plateSteel>, <mekanism:gastank>.withTag({tier: 0}).onlyWithTag({tier: 0}), <ore:plateSteel>],[<mekanism:gastank>.withTag({tier: 0}).onlyWithTag({tier: 0}), <mekanism:basicblock:8>, <mekanism:gastank>.withTag({tier: 0}).onlyWithTag({tier: 0})], [<ore:plateSteel>, <ic2:te:43>, <ore:plateSteel>]]);
...
recipes.addShaped(<mekanism:machineblock:14>, [[null, null, null],[<ore:plateSteel>, <mekanism:enrichedalloy>, <ore:plateSteel>], [<ic2:plate:16>, <mekanism:energytablet>, <ic2:plate:16>]]);
...
recipes.addShaped(<mekanism:basicblock2:9>, [[<ore:plateSteel>, <ic2:glass>, <ore:plateSteel>],[<ore:circuitAdvanced>, <mekanism:basicblock:8>, <ore:circuitAdvanced>], [<ore:plateSteel>, <minecraft:ender_eye>, <ore:plateSteel>]]);
...
recipes.addShaped(<mekanism:basicblock:9> * 9, [[<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>],[<ore:plateSteel>, <mekanism:basicblock:8>, <ore:plateSteel>], [<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>]]);
